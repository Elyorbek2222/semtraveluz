export default function TransferPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 pb-20 pt-24 text-center">
      ...
      <h1 className="text-2xl font-extrabold text-gray-900 mb-2">Transfer xizmati</h1>
      <p className="text-gray-500 max-w-xs">Aeroport → Mehmonxona transfer. Ushbu bo'lim tez orada to'ldiriladi.</p>
