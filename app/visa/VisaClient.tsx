        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 pt-28 pb-12 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a href="https://wa.me/998946642222" target="_blank" rel="noopener noreferrer"
              ...
              💬 {isUz ? "Viza narxini bilish" : "Узнать цену визы"}
            </a>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 mt-8">
        ...
        <div className="mb-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              { num: "01", emoji: "📞", uz: "Maslahat va tahlil", ru: "Консультация и анализ", descUz: "Menejerimiz siz bilan bog'lanib, kerakli viza turi va hujjatlarni tushuntiradi", descRu: "Менеджер свяжется и объяснит тип визы и список документов" },
        ...
        >
          ...
          <p className="text-sm mb-5" style={{ color: "rgba(255,255,255,0.8)" }}>
            {isUz ? "Hoziroq murojaat qiling — viza narxini bilib oling!" : "Оставьте заявку — менеджер подберёт лучшее решение!"}
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a href="https://wa.me/998946642222" target="_blank" rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full font-bold text-sm"
