...
export const DESTINATIONS: Record<string, Destination> = {
  ...
  dubai: {
    ...
    priceFrom: 522,
    nightsRange: "6",
    visaUz: "Viza kerak emas (30 kun)",
    visaRu: "Виза не нужна (до 30 дней)",
    flightHours: "~3 soat",
    bestSeasonUz: "Oktyabr–Aprel",
    bestSeasonRu: "Октябрь–Апрель",
    descUz: "Dubai — dunyoning eng zamonaviy va hashamatli shahri. Burj Khalifa, Palm Jumeirah, Dubai Mall va cho'l safarini bir sayohatda birlashtiring. O'zbekiston fuqarolari BAA ga vizasiz kiradimi — ha! SEM Travel Toshkentdan Dubayga $522 dan arzon turlar taklif qiladi (6 kecha, parvoz, mehmonxona, nonushta, transfer, sug'urta).",
    descRu: "Дубай — самый современный и роскошный город мира. Объедините в одной поездке Бурдж-Халифу, Пальм Джумейру, Dubai Mall и сафари в пустыне. Узбекистанцы входят в ОАЭ без визы до 30 дней! SEM Travel предлагает доступные туры в Дубай из Ташкента от $522 (6 ночей, перелёт, отель, завтрак, трансфер, страховка).",
    highlightsUz: [
      "🏙️ Burj Khalifa — dunyodagi eng baland bino",
      "🛍️ Dubai Mall — eng katta savdo markazi",
      "🌴 Palm Jumeirah orolida dam olish",
      "🐫 Cho'l safarida tuya minish va BBQ ziyofat",
    ...
    highlightsRu: [
      ...
      "🐫 Сафари в пустыне, верблюды и ужин BBQ",
      "💎 Золотой рынок и шоппинг",
    ],
    faqs: [
      {
        qUz: "O'zbekistonliklar uchun Dubai vizasi kerakmi?",
        qRu: "Нужна ли виза в Дубай для узбекистанцев?",
        aUz: "Yo'q! O'zbekiston fuqarolari BAA ga vizasiz kiradimi — 30 tungacha qolishingiz mumkin. Shuning uchun viza oformleniyasi shart emas.",
        aRu: "Нет! Граждане Узбекистана могут въезжать в ОАЭ без визы до 30 дней. Виза не требуется.",
      },
      {
      ...
      },
      {
        ...
        aUz: "Toshkentdan Dubai turlari $522 dan boshlanadi (6 kecha: parvoz + mehmonxona + nonushta + transfer + sug'urta).",
        aRu: "Туры в Дубай из Ташкента от $522 (6 ночей: перелёт + отель + завтрак + трансфер + страховка).",
      },
      {
        qUz: "Dubai da nima ko'rish kerak?",
        qRu: "Что посмотреть в Дубае?",
        aUz: "Burj Khalifa, Dubai Mall, Palm Jumeirah, Cho'l safari, Oltin bozori, Global Village. Barcha ekskursiyalar haqida batafsil >>",
        aRu: "Бурдж-Халифа, Dubai Mall, Пальм Джумейра, сафари в пустыне, Золотой рынок, Global Village. Подробнее об экскурсиях >>",
      },
      {
