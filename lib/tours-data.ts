...
export const TOURS: Tour[] = [
  ...
  {
    id: 9,
    title: "Issiq-Ko'l — Tog' va Ko'l Safarisi",
    slug: "issiq-kol-safari",
    destination: "Issiq-Ko'l",
    country: "Qirg'iziston",
    flag: "🇰🇬",
    category: ["adventure", "family", "culture"],
    duration: "5 kecha / 6 kun",
    nights: 5,
    hotelName: "Raduga Resort Cholpon-Ata",
    hotelStars: 4,
    departureCity: "Toshkent",
    price: 420,
    oldPrice: 580,
    rating: 4.6,
    reviewCount: 98,
    reviewSnippet: "Issiq-Ko'l — tabiat mo'jizasi! Suv shaffof, tog'lar go'zal, mehmonxona yoqimli.",
    ...
    viewersCount: 14,
    dealHoursLeft: 48,
    descUz: "Issiq-Ko'l — Qirg'izistondagi alpina ko'li, dengiz sathidan 1 600 m balandlikda joylashgan. Tog' havosi, shaffof ko'l suvi, qumli plyajlar va kanyonlar. Oila va sarguzasht izlovchilar uchun ideal. Toshkentdan 1 soat parvoz.",
    descRu: "Иссык-Куль — горное озеро Кыргызстана на высоте 1 600 м. Чистый горный воздух, прозрачная вода, песчаные пляжи и каньоны. Идеально для семей и любителей приключений. Перелёт из Ташкента 1 час.",
    highlightsUz: ["Shaffof ko'l suvida suzish va plyaj", "Qozon-Oydin va Jeti-Oguz kanyonlari", "At minish — tog' yo'llari", "Qirg'iz milliy oshxonasi va bozori", "Bishkek shahrini ko'rish (ixtiyoriy)"],
    highlightsRu: ["Купание в прозрачном озере и пляж", "Каньоны Козон-Ойдин и Жети-Огуз", "Конные прогулки по горным тропам", "Кыргызская национальная кухня и базар", "Посещение Бишкека (по желанию)"],
  },
  {
    id: 10,
    title: "Batumi & Tbilisi — Gruziya To'liq Turi",
    slug: "gruziya-batumi-tbilisi",
    destination: "Batumi",
    country: "Gruziya",
    flag: "🇬🇪",
    category: ["culture", "family", "couple"],
    duration: "6 kecha / 7 kun",
    nights: 6,
    hotelName: "Sheraton Batumi Hotel",
    hotelStars: 5,
    departureCity: "Toshkent",
    price: 680,
    oldPrice: 890,
    rating: 4.7,
    reviewCount: 167,
    reviewSnippet: "Gruziya — ovqati zo'r, odamlari mehribon, manzaralar ajoyib. Albatta borish kerak!",
    ...
    viewersCount: 31,
    dealHoursLeft: 24,
    descUz: "Tbilisi tarixiy mahallalari va Batumining qora dengiz plyajlarini birlashtirgan to'liq Gruziya turi. Vizasiz kirish, arzon narxlar, ajoyib milliy taomlar. Toshkentdan 2.5 soat parvoz.",
    descRu: "Полный тур по Грузии: исторические кварталы Тбилиси и черноморские пляжи Батуми. Безвизовый въезд, доступные цены, восхитительная национальная кухня. Перелёт из Ташкента 2.5 часа.",
    highlightsUz: ["Tbilisi — Mtatsminda, Narikala qal'asi, hammomlar", "Batumi boulevard — Qora dengiz plyaji", "Kazbegi tog'lari va Gergeti cherkovi", "Gruziya sharob va milliy taomlar (xinkali, xachapuri)", "Kutaisi — Prometheus g'ori"],
    highlightsRu: ["Тбилиси — Мтацминда, крепость Нарикала, серные бани", "Батумский бульвар — пляж Чёрного моря", "Горы Казбеги и церковь Гергети", "Грузинское вино и кухня (хинкали, хачапури)", "Кутаиси — пещера Прометея"],
  },
  {
    id: 11,
    title: "Xitoy Biznes Tur — Kanton Yarmarkasi & Pekin",
    slug: "xitoy-biznes-tur",
    destination: "Guangzhou & Pekin",
    country: "Xitoy",
    flag: "🇨🇳",
    category: ["biznes", "culture"],
    duration: "7 kecha / 8 kun",
    nights: 7,
    hotelName: "Guangzhou Marriott Hotel",
    hotelStars: 5,
    departureCity: "Toshkent",
    price: 1200,
    oldPrice: 1550,
    rating: 4.8,
    reviewCount: 54,
    reviewSnippet: "Kanton yarmarkasi uchun ideal tashkilot. Hamma hujjatlar vaqtida, menejer doim aloqada.",
    ...
    spotsLeft: 10,
    viewersCount: 19,
    descUz: "Xitoyga biznes tur: Guangzhoudagi Kanton yarmarkasi, Pekindagi savdo uchrashuvlari. Viza rasmiylashtiruv, mehmonxona, tarjimon, transfer — hammasi SEM Travel zimmasida. Ishbilarmon uchun to'liq paket.",
    descRu: "Бизнес-тур в Китай: Кантонская ярмарка в Гуанчжоу, деловые встречи в Пекине. Оформление визы, отель, переводчик, трансфер — всё берёт на себя SEM Travel. Полный пакет для деловых людей.",
    highlightsUz: ["Kanton yarmarkasiga kirish va yo'naltirish", "Guangzhou savdo markazlari shoping turi", "Pekin — Buyuk Xitoy devori ekskursiyasi", "Biznes tarjimon xizmati (UZ/RU-ZH)", "Visa (biznes toifasi) rasmiylashtirish"],
    highlightsRu: ["Посещение Кантонской ярмарки с гидом", "Шопинг-тур по торговым центрам Гуанчжоу", "Пекин — экскурсия на Великую стену", "Услуги бизнес-переводчика (UZ/RU-ZH)", "Оформление бизнес-визы в Китай"],
  },
];
