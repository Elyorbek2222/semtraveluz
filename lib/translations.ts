...
export const translations: Record<Lang, Translations> = {
  uz: {
    ...
    contact: {
      ...
      address: "Toshkent, Uchtepa tumani, Katta Xirmontepa ko'chasi, 12B",
    ...
    footer: {
      ...
      address: "Toshkent, Uchtepa tumani, Katta Xirmontepa, 12B",
      hours: "Dush–Shan: 9:00–19:00",
    },
    faq: {
  ...
  ru: {
    ...
    contact: {
      ...
      address: "Ташкент, Учтепинский район, ул. Катта Хирмонтепа, 12Б",
    ...
    footer: {
      ...
      address: "Ташкент, Учтепинский район, Катта Хирмонтепа, 12Б",
      hours: "Пн–Сб: 9:00–19:00",
    },
    faq: {
